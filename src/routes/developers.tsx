...

{
  ...
  "reasons": []
        ...
        <p className="mt-3 leading-relaxed text-ink-soft">
          ...
          Signed tree head: <span className="font-mono text-sm">GET /api/v1/ledger/sth</span>. Receipt:{" "}
          <span className="font-mono text-sm">GET /api/v1/ledger/receipt</span> (not Certificate
          Transparency). <span className="font-mono">included</span> /{" "}
          <span className="font-mono">signatureValid</span> /{" "}
          <span className="font-mono">receiptValid</span> are not diploma VALID. Fabric dumps are
